        ...
        <div class="col-md-6">
            <form action="/register" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="university_id" id="university_id"
                           aria-describedby="numer albumu"
                           placeholder="Podaj numer albumu" required>
                </div>
                <input type="hidden" class="form-control" name="nfc_id" id="nfc_id" aria-describedby="numer albumu"
                       value="{{$nfc->number}}" required>
